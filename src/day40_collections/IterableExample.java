...
public class IterableExample {
    ...
    public static void main(String[] args) {
        ...
        /*
        for (Integer each : list) { // this loop implicitly use iterable, not from collection, but it is hidden

            if(each < 5){
                list.remove(each);
            }
        } // this one and the one down below are different remove methods
        // One excepts an object
      */
        ...
        while (it.hasNext()) { // as soon as there is no element left to iterato, it.hasNext() will become false and while loop gets executed
