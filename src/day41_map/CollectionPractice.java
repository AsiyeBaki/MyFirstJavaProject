...
public class CollectionPractice {
    public static void main(String[] args) {
        ...
        //10
        System.out.println(lists.get(1).get(3)); // to get the element 10
       ...
       // System.out.println("l = " + l); // l ==[]
        ...
        System.out.println("listOfSets.size() = " + listOfSets.size());


        listOfSets.get(0).addAll(Arrays.asList(10,5,20));
        listOfSets.get(0).addAll(Arrays.asList(10,5,20)); // does NOT accept duplicates so it will not add these
