...
public class StringMethods1 {
    public static void main(String[] args) {
        ...
        // System.out.println("sixthChar = " + sixthChar); // this is not going to print anything because
        // Cydeo word's range 01234 so 5 is the biggest
        ...
        System.out.println(r1.equals(r2));  // true  // this is the way to compare the texts that inside of String
